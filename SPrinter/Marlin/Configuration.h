...
#define STRING_CONFIG_H_AUTHOR "(David Medina, SPrinter config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CAP SPrinter"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 25, 500 }
